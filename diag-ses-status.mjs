...
const host=`email.${REGION}.amazonaws.com`, service="ses", path="/v2/email/identities/primesocial-videos.de";
const now=new Date();
...
console.log("VerifiedForSending:", d.VerifiedForSendingStatus);
console.log("DKIM-Status:", d.DkimAttributes?.Status, "| SigningEnabled:", d.DkimAttributes?.SigningEnabled);
