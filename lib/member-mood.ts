...
// Wochen-Fragen sind situations-konkret und problem-spezifisch — die KI
// braucht konkrete Antworten ("kam zurueck mit Wild" vs "deutlich besser")
// um echtes Coaching geben zu koennen. 4-5 Fragen pro Problem-Key.
